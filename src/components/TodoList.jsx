...
function TodoList() {
  ...
  return (
    <div className="max-w-[600px] mx-auto mt-10 w-full">
      <div className="mx-2">
        ...
        <ul className="space-y-4">
          {todos.map((todo) => (
            <li
              key={todo.id}
              className="w-full bg-gray-200 overflow-hidden rounded-2xl p-6 shadow-md border-2 border-gray-300 flex justify-between items-center"
            >
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-2xl shadow-2xl w-[90%] max-w-md">
            ...
            <input
              ...
              className="w-full border-2 text-black border-gray-300 p-3 rounded-xl mb-5 focus:outline-none focus:ring-2 focus:ring-blue-400"
              autoFocus
            />
